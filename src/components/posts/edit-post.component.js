...
class CreatePost extends Component {
    ...
    componentDidMount() {
        axios.get('https://hgc-intranet.netlify.app/posts/' + this.props.match.params.id)
            .then(res => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.post('https://hgc-intranet.netlify.app/posts/update/' + this.props.match.params.id, post)
